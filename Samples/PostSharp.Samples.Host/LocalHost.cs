...
namespace PostSharp.Samples.Host
{
    ...
    internal class LocalHost : PostSharpLocalHost
    {
        ...
        {
            // Register to events.
            this.PostSharpObject.PhaseExecuted += OnPhaseExecuted;
            this.PostSharpObject.PhaseExecuting += OnPhaseExecuting;
        }

        private static void OnPhaseExecuting( object sender, PhaseExecutedEventArgs e )
        {
            Console.WriteLine( "This is the event PhaseExecuting for phase {0}.", e.Phase );
        }

        private static void OnPhaseExecuted( object sender, PhaseExecutedEventArgs e )
        {
