...
namespace PostSharp.Samples.Librarian.Data
{
    ...
    public sealed class StorageContext : EntityRepository, ISinglePhaseNotification
    {
        ...
        /// </summary>
        private readonly Dictionary<EntityKey, Entity> deletedEntities = new Dictionary<EntityKey, Entity>();
        ...
        /// <returns>The entity with this key.</returns>
        public Entity GetEntity( EntityKey entityKey, bool throwIfNotFound )
        {
            if ( entityKey.IsNull )
                throw new ArgumentNullException( "entityKey" );

            Entity entity = this.InternalGet( entityKey );
        ...
        /// </summary>
        /// <param name="entity">Entity (with null entity key).</param>
        /// <returns>The <see cref="EntityKey"/> that has been assigned to this entity.</returns>
        [Trace]
        public EntityKey Insert( Entity entity )
        {
            if ( entity == null )
                throw new ArgumentNullException( "entity" );
            if ( !entity.EntityKey.IsNull )
        ...
        [Trace]
        public void Delete( EntityRef<Entity> entity )
        {
            if ( entity.IsNull )
                throw new ArgumentNullException( "entity" );
        ...
        private IEnumerator<Entity> GetModifiedEntitiesEnumerator()
        {
        ...
        /// </summary>
        /// <returns>An enumerator.</returns>
        protected override IEnumerator<Entity> GetAllEntitiesEnumerator()
        {
            // Return the entities in the current context.
            IEnumerator<Entity> modifiedEnumerator = this.GetModifiedEntitiesEnumerator();
            ...
            IEnumerator<Entity> committedEnumerator = Storage.Current.GetAllEntitiesEnumerator();
            while ( committedEnumerator.MoveNext() )
            {
                Entity entity = committedEnumerator.Current;
