...
namespace PostSharp.Samples.Librarian.Data
{
    ...
    public sealed class Storage : EntityRepository
    {
        ...
        private Storage( string directory )
        {
            ...
            binaryFormatter.TypeFormat = FormatterTypeStyle.XsdString | FormatterTypeStyle.TypesWhenNeeded;
        ...
        private void Load()
        {
            ...
            for ( int i = 0 ; i < objectFiles.Length ; i++ )
            {
                try
                {
                    ...
                    {
                        Entity entity = (Entity) formatter.Deserialize( file );
        ...
        /// <summary>
        /// Makes a new (and unique) <see cref="EntityKey"/>.
        /// </summary>
        /// <returns>A new <see cref="EntityKey"/>.</returns>
        ...
        /// </summary>
        /// <param name="entity">Entity to be written.</param>
        [Trace]
        private void WriteObject( Entity entity )
        {
        ...
        internal Entity GetEntity( EntityKey key )
        {
        ...
        internal new IEnumerator<Entity> GetAllEntitiesEnumerator()
        {
