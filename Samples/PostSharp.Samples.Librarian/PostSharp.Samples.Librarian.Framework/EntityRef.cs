...
namespace PostSharp.Samples.Librarian.Framework
{
        ...
        where T : Entity
    {
        ...
        {
            return (T) Framework.Entity.EntityResolver.GetEntity( this.entityKey );
        }
        ...
        public static implicit operator EntityRef<Entity>( EntityRef<T> target )
        {
            return new EntityRef<Entity>( target.entityKey );
        }
