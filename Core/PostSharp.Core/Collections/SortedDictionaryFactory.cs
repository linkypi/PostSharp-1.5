...
namespace PostSharp.Collections
{
    ...
    public sealed class SortedDictionaryFactory<TKey, TValue> : IDictionaryFactory<TKey, TValue>
    {
        /// <summary>
        /// Default instance (using the default equality comparer).
        /// </summary>
        [SuppressMessage( "Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes" )] 
        public static readonly SortedDictionaryFactory<TKey, TValue> Default = new SortedDictionaryFactory<TKey, TValue>();
        ...
        /// <inheritdoc />
        public SortedDictionaryFactory(IComparer<TKey> comparer)
        {
